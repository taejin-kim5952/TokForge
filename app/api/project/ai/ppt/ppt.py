...
from .prompts import PPT_SYSTEM_PROMPT, parse_deck_json
...
def _build_system_prompt(overview_doc: dict, rag_context: str | None) -> str:
...
async def generate_ppt(
    ...
    system = _build_system_prompt(overview_doc, rag_text)
    ollama_request = {
